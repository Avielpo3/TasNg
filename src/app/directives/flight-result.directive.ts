...
export class FlightResultSelectedDirective implements OnInit, OnChanges {
  ...
  constructor(
    ...
    ngOnInit(): void {
        if (this.IsSelected) {
            this._renderer.addClass(this._elementRef.nativeElement, this.FlightSelectedClass);
    ...
    ngOnChanges(changes: SimpleChanges): void {
        if (changes.IsSelected) {
            ...
            if (changes.IsSelected.currentValue) {
                ...
                this._renderer.removeClass(this._elementRef.nativeElement, this.FlightSelectedClass);
    ...
    @HostListener('mouseenter') mouseEnter(event: Event) {
        this._renderer.addClass(this._elementRef.nativeElement, this.FlightHoverClass);
    }
    ...
    @HostListener('mouseleave') mouseLeave(event: Event) {
        this._renderer.removeClass(this._elementRef.nativeElement, this.FlightHoverClass);
    }
